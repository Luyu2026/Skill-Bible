...
| 🧩 [**Skill creation**](#skill-creation) | Build a career Skill chain from a profession, function, or JD | LuyuSkill meta Skill factory |
...
| Skill | What it helps with |
|---|---|
| [luyu-skill](./luyu-skill/) | LuyuSkill meta Skill factory: start with a profession, function, industry, or JD; research its recurring work and capability map; then build a career Skill chain with a controller, execution Skills, and an advisory layer. It can also update an existing career chain or create a domain advisory board. |
