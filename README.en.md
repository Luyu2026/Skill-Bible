...
| 🗄️ [**Office files**](#office-files) | Inspect files and backups before cleanup | Exact duplicate reports |
...
| Skill | What it helps with |
|---|---|
| [duplicate-file-report](./duplicate-file-report/) | Find byte-identical files, report duplicate groups, hardlinks and logical redundant bytes, and preserve all input files |
