...
| 🗃️ [**Office data**](#office-data) | Combine exported tables with source tracking | CSV multi-file merge |
...
| Skill | What it helps with |
|---|---|
| [csv-stack](./csv-stack/) | Append multiple CSV exports by column name, preserve text identifiers, and report source files and row counts |
