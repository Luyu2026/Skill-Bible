...
本文件记录 pm-prioritization-engine 的来源与改造说明。仅作归档用途，不影响使用。
...
| 原 Skill | `pm-prioritization-engine`（PM-Skill 2.0） |
| 原协议 | MIT License |
| Copy 时间 | 2026-09 |
...
- **references 保留**：`kano-analysis.md, scoring-models.md`（运行确实需要，随 Skill 一并发布）
