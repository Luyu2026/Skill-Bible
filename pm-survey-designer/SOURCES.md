...
本文件记录 pm-survey-designer 的来源与改造说明。仅作归档用途，不影响使用。
...
| 原 Skill | `pm-survey-designer`（PM-Skill 2.0） |
| 原协议 | MIT License |
| Copy 时间 | 2026-09 |
...
- **references 保留**：`bias-checklist.md, question-types.md`（运行确实需要，随 Skill 一并发布）
